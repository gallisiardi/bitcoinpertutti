...
v 0.0.8, {docdate}: Bozza completa in fase di revisione finale
:doctype: book
:icons: font
...
include::./includes/021_I_fork.adoc[I fork]

<<<

include::./includes/022_Le_mining_pool.adoc[Le mining pool]
